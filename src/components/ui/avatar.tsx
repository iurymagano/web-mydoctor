...
export const AvatarProfile = ({
  ...
  return (
    <div className="relative" onClick={onClick}>
      {edit && (
        <div className=" absolute bottom-4 right-0 z-10 flex cursor-pointer items-center justify-center rounded-[50%] bg-[--primary] p-1 transition-all hover:scale-[110%]">
          <MdEdit className="text-white" />
        </div>
      )}

      <Avatar
        className={`rounded-[50%]  border-[2px] border-[#74768bb0] ${className} `}
      >
